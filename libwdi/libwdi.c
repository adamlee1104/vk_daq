...
static const char* driver_name[WDI_NB_DRIVERS-1] = {"libusbK.dll", "winusbcoinstaller2.dll", "libusb0.dll", ""};
static const char* inf_template[WDI_NB_DRIVERS-1] = {"libusbk.inf.in", "winusb.inf.in", "libusb0.inf.in", "usbser.inf.in"};
static const char* cat_template[WDI_NB_DRIVERS-1] = {"libusbk.cat.in", "winusb.cat.in", "libusb0.cat.in", "usbser.cat.in"};
static const char* ms_compat_id[WDI_NB_DRIVERS-1] = {"MS_COMP_LIBUSBK", "MS_COMP_WINUSB", "MS_COMP_LIBUSB0", "MS_COMP_USBSER"};
								  ...
								  const char* inf, struct wdi_options_prepare_driver* options)
{
	...
	if (IsUserAnAdmin()) {
		...
		static_sprintf(cert_subject, "CN=Vkinging Inc.", hw_id);
